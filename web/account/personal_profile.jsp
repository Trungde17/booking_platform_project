                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="account-info">
                            <div class="card-body d-flex align-items-center">
                                <img id="avatar_img" src="${pageContext.request.contextPath}/processimg" alt="Profile Picture" class="rounded-circle" data-bs-toggle="modal" data-bs-target="#avatarModal">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <img id="full_avatar_img" src="${pageContext.request.contextPath}/processimg" alt="Full Profile Picture" class="img-fluid">
                </div>
